      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <a
            ...
            style={{ backgroundColor: "#EC94B2" }}
            onMouseEnter={(e) =>
              (e.currentTarget.style.backgroundColor = "#DC7098")
            }
            onMouseLeave={(e) =>
              (e.currentTarget.style.backgroundColor = "#EC94B2")
            }
          >
            <svg
              className="w-5 h-5"
          ...
          <div className="flex items-center gap-4 max-w-xs mx-auto mb-8">
            ...
            <span className="text-xs font-dm" style={{ color: "#9B7777" }}>
              or find me on
            </span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
          ...
          <div className="flex items-center justify-center flex-wrap gap-3 mb-14">
            <a
              ...
              style={{ color: "#BEA5A5", borderColor: "rgba(255,255,255,0.1)" }}
            >
          ...
          <div
            ...
            style={{ borderColor: "rgba(255,255,255,0.06)", color: "#826868" }}
          >
