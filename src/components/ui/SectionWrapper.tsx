...
export function SectionHeading({ id, heading, subheading, centered = false, light = false }: SectionHeadingProps) {
  return (
    <div className={`mb-16 ${centered ? "text-center" : ""}`}>
      ...
      <div className={`mt-4 h-px w-16 ${light ? "bg-[#f7ddd5]/30" : "bg-[#d8a4af]"} ${centered ? "mx-auto" : ""}`} />
    </div>
  );
}
